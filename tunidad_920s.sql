...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-10-2024 a las 23:22:19
...
(1, 1, 'activo', '2024-10-20'),
(2, 3, 'activo', '2024-10-21');
...
(1, 1, 5, 'propietario', 'activo'),
(2, 2, 6, 'servicio', 'activo'),
(3, 2, 10, 'propietario', 'activo'),
(4, 2, 8, 'servicio', 'activo'),
(5, 2, 3, 'servicio', 'activo');
...
CREATE TABLE `persona` (
  ...
  `tipo_identificacion` enum('cc','pasaporte','extranjeria') DEFAULT NULL,
...
(1, 'Gustavo', 'Rodriguez', 'm', '2024-10-09', 'cc', '1061', '2313112', 'gustavoexample23@gmail.com', 679, 'Calle 13 #12-21', '23123'),
(2, 'Kevin', 'Garcia', 'm', '1990-01-05', 'cc', '123456789', '3110000001', 'kevin.garcia@gmail.com', 150, 'Calle 1 #1-1', '12345'),
(3, 'Ana', 'Martinez', 'f', '1985-05-20', 'cc', '987654321', '3110000002', 'ana.martinez@gmail.com', 679, 'Calle 2 #2-2', '12345'),
(4, 'Gonazalo', 'Gomez', 'm', '1980-08-15', 'cc', '555555555', '3110000003', 'gonzalo.gomez@gmail.com', 679, 'Calle 3 #3-3', '12345'),
(5, 'Maria', 'Perez', 'f', '1995-09-09', 'cc', '666666666', '3110000004', 'maria.perez@gmail.com', 788, 'Calle 4 #4-4', '12345'),
(6, 'Luis', 'Torres', 'm', '1992-11-30', 'cc', '777777777', '3110000005', 'luis.torres@gmail.com', 485, 'Calle 5 #5-5', '12345'),
(7, 'Sara', 'Diaz', 'f', '1998-07-25', 'cc', '888888888', '3110000006', 'sara.diaz@gmail.com', 485, 'Calle 6 #6-6', '12345'),
(8, 'Jorge', 'Lopez', 'm', '1991-03-10', 'cc', '999999999', '3110000007', 'jorge.lopez@gmail.com', 585, 'Calle 7 #7-7', '12345'),
(9, 'Rubiel', 'Ramirez', 'm', '1987-12-17', 'cc', '111111111', '3110000008', 'rubiel.ramirez@gmail.com', 585, 'Calle 8 #8-8', '12345'),
(10, 'Laura', 'Vargas', 'f', '1993-06-02', 'cc', '222222222', '3110000009', 'laura.vargas@gmail.com', 150, 'Calle 9 #9-9', '12345'),
(11, 'Andres', 'Morales', 'm', '1996-10-22', 'cc', '333333333', '3110000010', 'anres.morales@gmail.com', 547, 'Calle 10 #10-10', '12345');
...
(1, 'gustavoexample23@gmail.com', 'popayan123', 1, 1),
...
ALTER TABLE `detalle_inmueble_pago`
  ...
  ADD CONSTRAINT `fk_detalle_inmueble_pago_persona` FOREIGN KEY (`id_persona`) REFERENCES `detalle_inmueble_persona` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `municipio`
  ADD CONSTRAINT `fk_municipio_departamento` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id`);
